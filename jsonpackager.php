...
set_time_limit(0);
define("MODULES_DIR", "/var/www/html/Provisioner/endpoint");
define("RELEASE_DIR", "/var/www/html/release/v3");
define("ROOT_DIR", "/var/www/html/Provisioner");
...
$html .= "<a href='/release/v3/master.xml'>master.xml</a>";
...
function create_brand_pkg($rawname,$version,$brand_name,$old_brand_timestamp,$c_message) {	
	...
	if($brand_max != $old_brand_timestamp) {
		...
		$brands_html .= "XML File: <a href='/release/v3/".$rawname."/".$rawname.".xml'>".$rawname.".xml</a><br/>";
