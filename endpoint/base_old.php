...
abstract class endpoint_base {
	 ...
	 */
	function merge_arrays($original_array, $new_array) {
	...
	function import_settings($filename) {
		$tmp = $this->file2json($filename);
	    ...
	    $this->settings = $this->merge_arrays($this->settings, $tmp);
